          ...
          {step === "role" ? (
            <>
              ...
              <div className="space-y-3">
                {[
                  { value: "STUDENT", label: "Job Seeker", description: "Find and apply for jobs" },
                  { value: "RECRUITER", label: "Recruiter", description: "Post jobs and find talent" },
                ].map((option) => (
                  <button
                    key={option.value}
                    onClick={() => {
            ...
            <>
              <button onClick={() => setStep("role")} className="text-primary-600 text-sm hover:text-primary-700 mb-4">
                ← Change role
              </button>
