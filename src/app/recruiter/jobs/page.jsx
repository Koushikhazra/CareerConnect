  ...
  return (
    <div className="section-container py-12">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href="/recruiter/post-job" className="flex items-center gap-2 bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 transition font-medium">
          <Plus size={20} />
          Post New Job
        </Link>
      </div>
      ...
      <div className="card text-center py-12">
        ...
        <Link href="/recruiter/post-job" className="inline-block bg-primary-600 text-white px-6 py-2 rounded-lg hover:bg-primary-700 transition">
          Post a Job Now
        </Link>
      </div>
    </div>
